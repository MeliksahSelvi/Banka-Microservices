package com.melik.creditcard.service.security.filter;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.melik.creditcard.service.common.exception.CreditCardDomainBusinessException;
import com.melik.creditcard.service.common.rest.ErrorResponse;
import com.melik.creditcard.service.security.credentials.JwtUserDetails;
import com.melik.creditcard.service.security.util.JwtTokenUtil;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private JwtUserDetails getJwtUserDetailsFromToken(String token)  {
        ...
        try {
            ...
            throw new CreditCardDomainBusinessException("Could not create JwtUserDetails json!", e);
        }
    }
