package com.melik.customer.service.security.filter;

import com.fasterxml.jackson.core.JsonProcessingException;
import com.fasterxml.jackson.databind.ObjectMapper;
import com.melik.customer.service.common.exception.CustomerDomainBusinessException;
import com.melik.customer.service.common.rest.ErrorResponse;
import com.melik.customer.service.security.util.JwtTokenUtil;
import com.melik.customer.service.security.credentials.JwtUserDetails;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private JwtUserDetails getJwtUserDetailsFromToken(String token) {
        ...
        try {
            ...
            throw new CustomerDomainBusinessException("Could not create JwtUserDetails json!", e);
        }
    }
