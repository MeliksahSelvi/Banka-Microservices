...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    private void arrangementResponse(HttpServletResponse response) {
    ...
    private JwtUserDetails getJwtUserDetailsFromToken(String token) {
        ...
        try {
            ...
            throw new UserDomainBusinessException("Could not read JwtUserDetails object!", e);
        }
    }
    ...
    private void returnErrorResponse(HttpServletResponse response) {
        ...
        try {
            ...
            throw new UserDomainBusinessException("Could not create ErrorDTO json!", e);
        } catch (IOException e) {
